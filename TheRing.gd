...
func getVeinAt(pos)->String:
	...
	var p5 = getVeinPixelAt(pos / 2014.0)
	var p6 = getVeinPixelAt(pos / - 1384.0)
	var p7 = getVeinPixelAt(pos /  2684.0)

	var values = [p1.r, p1.g, p1.b, p1.a, p2.r, p2.b, p2.g, p2.a, p3.r, p3.b, p3.g, p3.a, p4.r, p4.b, p4.g, p4.a, p5.r, p5.b, p5.g, p5.a, p6.r, p6.b, p6.g, p6.a, p7.r, p7.b, p7.g, p7.a]
